...
func shoot():
	if canShoot:
		...
		bulletNode1.global_position = marker_2d.global_position + Vector2(0, -10) 
		bulletNode2.global_position = marker_2d.global_position 
		bulletNode3.global_position = marker_2d.global_position + Vector2(0, 10)  
